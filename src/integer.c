...
#define P101_FAULT_RETURN_PARSED_ARG3(env_arg, return_type, default_arg, expression)                                                                                                                                                                               \
    do                                                                                                                                                                                                                                                             \
    {                                                                                                                                                                                                                                                              \
...
static intmax_t parse_integer(const struct p101_env *env, struct p101_error *err, const char *str, intmax_t default_value, intmax_t min_value, intmax_t max_value)
{
    ...
    if(p101_error_has_error(err))
    {
        if(p101_error_is_errno(err, ERANGE))
        {
...
char p101_parse_char(const struct p101_env *env, struct p101_error *err, const char *str, char default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, char, default_value, (char)parse_integer(env, err, str, default_value, CHAR_MIN, CHAR_MAX));
}
...
short p101_parse_short(const struct p101_env *env, struct p101_error *err, const char *str, short default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, short, default_value, (short)parse_integer(env, err, str, default_value, SHRT_MIN, SHRT_MAX));
}
...
int p101_parse_int(const struct p101_env *env, struct p101_error *err, const char *str, int default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int, default_value, (int)parse_integer(env, err, str, default_value, INT_MIN, INT_MAX));
}
...
long p101_parse_long(const struct p101_env *env, struct p101_error *err, const char *str, long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, long, default_value, parse_integer(env, err, str, default_value, LONG_MIN, LONG_MAX));
}
...
long long p101_parse_long_long(const struct p101_env *env, struct p101_error *err, const char *str, long long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, long long, default_value, (long long)parse_integer(env, err, str, default_value, LLONG_MIN, LLONG_MAX));
}
...
unsigned char p101_parse_unsigned_char(const struct p101_env *env, struct p101_error *err, const char *str, unsigned char default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, unsigned char, default_value, (unsigned char)parse_unsigned_integer(env, err, str, default_value, UCHAR_MAX));
}
...
unsigned short p101_parse_unsigned_short(const struct p101_env *env, struct p101_error *err, const char *str, unsigned short default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, unsigned short, default_value, (unsigned short)parse_unsigned_integer(env, err, str, default_value, USHRT_MAX));
}
...
unsigned int p101_parse_unsigned_int(const struct p101_env *env, struct p101_error *err, const char *str, unsigned int default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, unsigned int, default_value, (unsigned int)parse_unsigned_integer(env, err, str, default_value, UINT_MAX));
}
...
unsigned long p101_parse_unsigned_long(const struct p101_env *env, struct p101_error *err, const char *str, unsigned long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, unsigned long, default_value, parse_unsigned_integer(env, err, str, default_value, ULONG_MAX));
}
...
unsigned long long p101_parse_unsigned_long_long(const struct p101_env *env, struct p101_error *err, const char *str, unsigned long long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, unsigned long long, default_value, (unsigned long long)parse_unsigned_integer(env, err, str, default_value, ULLONG_MAX));
}
...
signed char p101_parse_negative_char(const struct p101_env *env, struct p101_error *err, const char *str, signed char default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, signed char, default_value, (signed char)parse_integer(env, err, str, default_value, SCHAR_MIN, -1));
}
...
short p101_parse_negative_short(const struct p101_env *env, struct p101_error *err, const char *str, short default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, short, default_value, (short)parse_integer(env, err, str, default_value, SHRT_MIN, -1));
}
...
int p101_parse_negative_int(const struct p101_env *env, struct p101_error *err, const char *str, int default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int, default_value, (int)parse_integer(env, err, str, default_value, INT_MIN, -1));
}
...
long p101_parse_negative_long(const struct p101_env *env, struct p101_error *err, const char *str, long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, long, default_value, parse_integer(env, err, str, default_value, LONG_MIN, -1L));
}
...
long long p101_parse_negative_long_long(const struct p101_env *env, struct p101_error *err, const char *str, long long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, long long, default_value, (long long)parse_integer(env, err, str, default_value, LLONG_MIN, -1LL));
}
...
char p101_parse_positive_char(const struct p101_env *env, struct p101_error *err, const char *str, char default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, char, default_value, (char)parse_integer(env, err, str, default_value, 1, CHAR_MAX));
}
...
short p101_parse_positive_short(const struct p101_env *env, struct p101_error *err, const char *str, short default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, short, default_value, (short)parse_integer(env, err, str, default_value, 1, SHRT_MAX));
}
...
int p101_parse_positive_int(const struct p101_env *env, struct p101_error *err, const char *str, int default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int, default_value, (int)parse_integer(env, err, str, default_value, 1, INT_MAX));
}
...
long p101_parse_positive_long(const struct p101_env *env, struct p101_error *err, const char *str, long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, long, default_value, parse_integer(env, err, str, default_value, 1, LONG_MAX));
}
...
long long p101_parse_positive_long_long(const struct p101_env *env, struct p101_error *err, const char *str, long long default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, long long, default_value, (long long)parse_integer(env, err, str, default_value, 1, LLONG_MAX));
}
...
int8_t p101_parse_int8_t(const struct p101_env *env, struct p101_error *err, const char *str, int8_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int8_t, default_value, (int8_t)parse_integer(env, err, str, default_value, INT8_MIN, INT8_MAX));
}
...
int16_t p101_parse_int16_t(const struct p101_env *env, struct p101_error *err, const char *str, int16_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int16_t, default_value, (int16_t)parse_integer(env, err, str, default_value, INT16_MIN, INT16_MAX));
}
...
int32_t p101_parse_int32_t(const struct p101_env *env, struct p101_error *err, const char *str, int32_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int32_t, default_value, (int32_t)parse_integer(env, err, str, default_value, INT32_MIN, INT32_MAX));
}
...
int64_t p101_parse_int64_t(const struct p101_env *env, struct p101_error *err, const char *str, int64_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int64_t, default_value, parse_integer(env, err, str, default_value, INT64_MIN, INT64_MAX));
}
...
uint8_t p101_parse_uint8_t(const struct p101_env *env, struct p101_error *err, const char *str, uint8_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, uint8_t, default_value, (uint8_t)parse_unsigned_integer(env, err, str, default_value, UINT8_MAX));
}
...
uint16_t p101_parse_uint16_t(const struct p101_env *env, struct p101_error *err, const char *str, uint16_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, uint16_t, default_value, (uint16_t)parse_unsigned_integer(env, err, str, default_value, UINT16_MAX));
}
...
uint32_t p101_parse_uint32_t(const struct p101_env *env, struct p101_error *err, const char *str, uint32_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, uint32_t, default_value, (uint32_t)parse_unsigned_integer(env, err, str, default_value, UINT32_MAX));
}
...
uint64_t p101_parse_uint64_t(const struct p101_env *env, struct p101_error *err, const char *str, uint64_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, uint64_t, default_value, parse_unsigned_integer(env, err, str, default_value, UINT64_MAX));
}
...
int8_t p101_parse_negative_int8_t(const struct p101_env *env, struct p101_error *err, const char *str, int8_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int8_t, default_value, (int8_t)parse_integer(env, err, str, default_value, INT8_MIN, -1));
}
...
int16_t p101_parse_negative_int16_t(const struct p101_env *env, struct p101_error *err, const char *str, int16_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int16_t, default_value, (int16_t)parse_integer(env, err, str, default_value, INT16_MIN, -1));
}
...
int32_t p101_parse_negative_int32_t(const struct p101_env *env, struct p101_error *err, const char *str, int32_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int32_t, default_value, (int32_t)parse_integer(env, err, str, default_value, INT32_MIN, -1));
}
...
int64_t p101_parse_negative_int64_t(const struct p101_env *env, struct p101_error *err, const char *str, int64_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int64_t, default_value, parse_integer(env, err, str, default_value, INT64_MIN, -1));
}
...
int8_t p101_parse_positive_int8_t(const struct p101_env *env, struct p101_error *err, const char *str, int8_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int8_t, default_value, (int8_t)parse_integer(env, err, str, default_value, 1, INT8_MAX));
}
...
int16_t p101_parse_positive_int16_t(const struct p101_env *env, struct p101_error *err, const char *str, int16_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int16_t, default_value, (int16_t)parse_integer(env, err, str, default_value, 1, INT16_MAX));
}
...
int32_t p101_parse_positive_int32_t(const struct p101_env *env, struct p101_error *err, const char *str, int32_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int32_t, default_value, (int32_t)parse_integer(env, err, str, default_value, 1, INT32_MAX));
}
...
int64_t p101_parse_positive_int64_t(const struct p101_env *env, struct p101_error *err, const char *str, int64_t default_value)
{
    ...
    P101_FAULT_RETURN_PARSED_ARG3(env, int64_t, default_value, parse_integer(env, err, str, default_value, 1, INT64_MAX));
}

#undef P101_FAULT_RETURN_PARSED_ARG3
